...
public class TestRedis {
	...
	public static void main(String[] args) throws Exception {
		...
		// userinfo.put("id", 10);
		// userinfo.put("name", "韩凯浩");
		// userinfo.put("age", 24);
		// userinfo.put("address", "河南省郑州市");
		// redisUtil.hmset("user", userinfo);
		Map<Object, Object> userinfo = redisUtil.hmget("user");
		...
		// redisUtil.set("name", "韩凯浩", 50);
		// long time = 0;
		// while ((time = redisUtil.getExpire("name")) > 0) {
